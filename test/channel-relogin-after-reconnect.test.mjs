...
const ROUTE = [
  { cwd: '/Users/you/work/tlda', tmux_session: 'fleet-relogin' },
  { cwd: '/Users/you/worktrees/moved', tmux_session: 'fleet-relogin' },
]
...
test('identical route facts still coalesce rather than duplicating the login', async () => {
  ...
  const body = { agent_id: AGENT, cwd: '/Users/you/work/tlda' }
