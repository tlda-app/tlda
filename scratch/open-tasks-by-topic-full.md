...
| 1d | unestablished | `tlda-recovery-chief-sol` | never picked up | Ownership transfer while the chief/package lane has the next | One of **five** rows on `tlda-recovery-chief-sol` sharing this transfer note as their title — the §3 defect on a live agent. The owner is **awake**; one question to them recovers all five subjects. |
| 1d | unestablished | `tlda-recovery-chief-sol` | never picked up | Ownership transfer while the chief/package lane has the next | One of **five** rows on `tlda-recovery-chief-sol` sharing this transfer note as their title — the §3 defect on a live agent. The owner is **awake**; one question to them recovers all five subjects. |
| 1d | unestablished | `tlda-recovery-chief-sol` | never picked up | Ownership transfer while the chief/package lane has the next | One of **five** rows on `tlda-recovery-chief-sol` sharing this transfer note as their title — the §3 defect on a live agent. The owner is **awake**; one question to them recovers all five subjects. |
